...
class Publication
{
    ...
    public function __toString__($pseudoUsr)
    {
      ...
      <form method='POST' action='delete_post.php'>
        <input class='d-none' type='text' name='from' value='category'>
        <input class='d-none' type='text' name='cat_id' value='" . $this->category . "'>
...
?>
        ...
        <head>
            <meta charset="utf-8">
            <title>Catégorie | <?php echo $_GET['cat_id']; ?></title>
        ...
        <body>
            ...
            <div class="container-fluid bg-light text-dark">
                <h1><?php echo "Publications de la catégorie : " . $_GET['cat_id']; ?></h1>
            </div>
